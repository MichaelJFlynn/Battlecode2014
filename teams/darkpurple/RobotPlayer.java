						...
						if(attack_buddies.length >= 1 ) {
							...
							if(rcf.canMove(enemy_dir)) {
								if(buddy.distanceSquaredTo(enemy_loc) <= attackRadius && rcf.senseNearbyGameObjects(Robot.class, rcf.getLocation().add(enemy_dir), attackRadius, rcf.getTeam().opponent()).length <= attack_buddies.length  ) {
									...
									if(rcf.senseNearbyGameObjects(Robot.class, rcf.getLocation().add(enemy_dir), attackRadius, rcf.getTeam().opponent()).length <= attack_buddies.length  ){
										if(!buddy.add(buddy_dir).equals(rcf.getLocation().add(enemy_dir)) && walkable_tile(buddy.add(buddy_dir)) &&
												rcf.senseObjectAtLocation(buddy.add(buddy_dir)) ==null && rcf.senseNearbyGameObjects(Robot.class, buddy.add(buddy_dir),(int) (attackRadius + 2*sqrt_attackRadius + 1), rcf.getTeam().opponent()).length <= attack_buddies.length &&
											...
											if(!buddy.add(buddy_dir_right).equals(rcf.getLocation().add(enemy_dir)) && walkable_tile(buddy.add(buddy_dir_right)) &&
													rcf.senseObjectAtLocation(buddy.add(buddy_dir_right)) ==null && rcf.senseNearbyGameObjects(Robot.class, buddy.add(buddy_dir_right),(int) (attackRadius + 2*sqrt_attackRadius + 1), rcf.getTeam().opponent()).length <= attack_buddies.length &&
													rcf.senseRobotInfo(rob).health > LOW_HEALTH
													) {
												...
												if(!buddy.add(buddy_dir_left).equals(rcf.getLocation().add(enemy_dir)) && walkable_tile(buddy.add(buddy_dir_left)) &&
														rcf.senseObjectAtLocation(buddy.add(buddy_dir_left)) ==null && rcf.senseNearbyGameObjects(Robot.class, buddy.add(buddy_dir_left),(int) (attackRadius + 2*sqrt_attackRadius + 1), rcf.getTeam().opponent()).length <= attack_buddies.length &&
														rcf.senseRobotInfo(rob).health > LOW_HEALTH
														) {
								...
								if(rcf.canMove(enemy_dir_left)) {
									if(buddy.distanceSquaredTo(enemy_loc) < attackRadius && rcf.senseNearbyGameObjects(Robot.class, rcf.getLocation().add(enemy_dir_left), attackRadius, rcf.getTeam().opponent()).length <= 2) {
										...
										if(rcf.senseNearbyGameObjects(Robot.class, rcf.getLocation().add(enemy_dir_left), attackRadius, rcf.getTeam().opponent()).length <= attack_buddies.length  ){
									...
									if(rcf.canMove(enemy_dir_right)) {
										if(buddy.distanceSquaredTo(enemy_loc) < attackRadius && rcf.senseNearbyGameObjects(Robot.class, rcf.getLocation().add(enemy_dir_right), attackRadius, rcf.getTeam().opponent()).length <= 2) {
											...
											if(rcf.senseNearbyGameObjects(Robot.class, rcf.getLocation().add(enemy_dir_right), attackRadius, rcf.getTeam().opponent()).length <= attack_buddies.length  ){
